...
// Lấy danh sách bài viết thuộc danh mục nếu có ID danh mục được chuyển vào URL
$posts = array();
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $id = $_GET['id'];
    $sqlPosts = "SELECT * FROM posts WHERE category_id = '$id' ORDER BY created_at DESC";
...
<?php foreach ($posts as $post) : ?>
                            <!-- Phần mã HTML hiển thị bài viết -->
                            <div class="row pb-4">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-7 animate-box">
                                    ...
                                    <a href="posts.php?id=<?php echo $post['id']; ?>" class="fh5co_mini_time py-3"><?php echo $post['author']; ?> - <?php echo date('F d, Y', strtotime($post['created_at'])); ?></a>
                                </div>
                            </div>
                            <?php endforeach; ?>
                <!--  -->
